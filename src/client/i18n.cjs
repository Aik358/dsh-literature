...
const en = {
  ...
  action: {
    ...
    reidentify: 'Re-resolve metadata',
    reidentifyDone: 'Metadata re-resolved',
  ...
  settings: {
    ...
    savebarHint: 'Remember to save your changes',
    saved: 'Saved',
  ...
  list: {
    ...
    confirmDiscard: 'Remove the selected items?',
    discarded: 'Removed: ',
    retried: 'Retried: ',
